...
class AVLTree:
    ...
    def insert(self, value: Any):
        ...
        """
        def _insert(node: AvlNode, value):
            """Recursive helper for insertion.

            Will insert a new node using the BST insertion algorithm, then balance the
            tree, as necessary.

            Args:
                node (AvlNode): The current node being examined.
                value: The value to insert.
    ...
    def print_tree(self, node: AvlNode=None, level: int=0, prefix: str='Root:') -> None:
